...
| `move_to_thread` | Searchable | Member | Move the conversation into a new managed public thread, optionally in an allowlisted target channel. Requires `THREAD_HANDOFF_ENABLED`. |
